...
from utils import last_speech_detected_seconds, text_transcribed, tools_running, generated_sentences, sleep_02, empty_time_speech_detected, move_bonjour_to_generated, empty_live
import logging
import time
...
class StateMachine:
    ...
    def __init__(self):
        self.states = {
            ...
            "CONV"      : State(number=1, name="CONV",      start_tools=['T0'], stop_tools=['T6', 'T8'], on_enter=(empty_time_speech_detected, move_bonjour_to_generated, sleep_02)),
            "LISTEN"    : State(number=2, name="LISTEN",    start_tools=['T1', 'T6', 'T7', 'T8'], on_exit=(self.edit_prompt,), on_enter=(sleep_02,)),
        ...
        self.conditions = {
            ...
            "START_GEN" : {"WAIT"       : self.cond_true}, # GEN not WAIT TODO
