...
def start_servers():
    ...
    server_T6_command = "py -2.7 Tools/T6_RecordAudio/app.py"
    server_T8_command = "py -3.11 Tools/T8_STT/app.py"
    server_T3_command = "py -3.10 Tools/T3_TTS/app.py"
    server_T0_command = "py -2.7 Tools/T0_ReadAudio/app.py"
