...
def main():
    ...
    ollama_model_name = "openchat" # "llama2" "mistral" "mixtral" "openchat" "gemma"
    ...
    user2 = Assistant(name=name2, mood="neutre", work="Pacte Novation", role="user", ollama_model_name=ollama_model_name, model=local_llm)
